...
class sdfnet(nn.Module):
    ...
    def forward(self, image_batch, points_batch, trans_mat=None, mode='global_and_local_features'):
        ...
        if trans_mat != None and mode != 'global_features_only':
        ...
        if trans_mat != None and mode == 'global_and_local_features':
            sdf = self.global_decoder(global_features) + self.local_decoder(local_features)
        elif trans_mat != None and mode == 'local_features_only':
            sdf = self.local_decoder(local_features)
        else:
